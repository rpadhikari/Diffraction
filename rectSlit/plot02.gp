...
set output 'diff02.ps'
set xr [-1.5:1.5]
set yr [0.0:1.0]
set xl 'angle (rad)'
set label at -1.4,0.9 'Slit width = 0.10 mm'
...
plot 'out.dat' u 1:4 w l ti '500 nm' ls 1,\
 'out.dat' u 1:5 w l ti '600 nm' ls 2,\
 'out.dat' u 1:6 w l ti '700 nm' ls 3
set output
! ps2pdf diff02.ps
! rm diff02.ps
